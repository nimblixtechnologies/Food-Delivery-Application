...
from .views import CartView, CheckoutView, OrderListView, OrderUpdateView, DeliveryPartnerUpdateStatusAPIView
...
urlpatterns = [
    ...
    path(
        "partner/order/<int:order_id>/status/",
        DeliveryPartnerUpdateStatusAPIView.as_view(),
